...
const Cart = () => {
  ...
  return (
    <>
      <div className={cn("absolute top-0 -right-[400px] w-96 bg-background h-dvh flex flex-col justify-between gap-4 p-4 shadow-lg transition-all duration-300", isOpenCart && "right-0")}>
        ...
        <div className="flex gap-1 mt-auto">
          ...
          <Button className="w-1/2" onClick={() => dispatch(setIsOpenCart())}>
